...
export class FooterArrendadorComponent implements OnInit {
  constructor(
    ...
    private authGuardService1: AuthGuardService // Inyectar el servicio AuthGuard
  ) {}

  ngOnInit(): void {
    // Usar el servicio AuthGuard para verificar autenticación y rol
    this.authGuardService1.checkAuthenticationAndRole('ARRENDADOR');
  }
  ...
  logout() {
    this.authGuardService1.logout(); // Usar el método logout del servicio AuthGuard
