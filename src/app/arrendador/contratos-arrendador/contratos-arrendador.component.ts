...
@Component({
  ...
  imports: [CommonModule, NavbarArrendadorComponent, FooterArrendadorComponent]
})
export class ContratosArrendadorComponent implements OnInit {
  ...
  constructor(
    ...
    private contratosService1: ContratosService
  ) {}
  ...
  obtenerContratos() {
    this.contratosService1.getContratosArrendador().subscribe(
      (data) => {
  ...
  aceptarContrato(id: number) {
    this.contratosService1.aceptarContrato(id).subscribe(
      (response) => {
  ...
  rechazarContrato(id: number) {
    this.contratosService1.rechazarContrato(id).subscribe(
      (response) => {
